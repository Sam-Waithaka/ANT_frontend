...
const BibleReadingExcel = () => {
  ...
  const generateExcel = () => {
    ...
    try {
      ...
      const BOM = '\uFEFF';
      let csvContent = BOM + 'Week,Day 1,Day 2,Day 3,Day 4,Day 5\n';
      ...
      link.setAttribute('download', '52-Week-Bible-Reading-Plan.csv');
      link.style.visibility = 'hidden';
      document.body.appendChild(link);
      link.click();
      document.body.removeChild(link);
      
      setStatus('CSV file downloaded successfully! You can open it in Excel.');
    ...
    <div className={`min-h-screen p-8 transition-colors duration-300 ${
      ...
      <div className="max-w-4xl mx-auto">
        <div className={`rounded-lg shadow-xl p-8 transition-colors duration-300 ${
          ...
          <div className="flex justify-between items-start mb-4">
            <div>
              ...
              <p className={darkMode ? 'text-gray-400' : 'text-gray-600'}>
                5 Days per Week | Old Testament + New Testament Concurrent
              </p>
            </div>
            <button
          ...
          <div className={`rounded-lg p-6 mb-6 border transition-colors duration-300 ${
            darkMode 
            ...
            <ul className={`space-y-1 ${
              ...
              <li>• 52 weeks of guided Bible reading</li>
              <li>• 5 days of reading per week</li>
              <li>• Old Testament and New Testament readings each day</li>
              <li>• Complete coverage of the entire Bible in one year</li>
            </ul>
          </div>
          
          <button
            onClick={generateExcel}
            className={`w-full font-semibold py-4 px-6 rounded-lg transition duration-200 flex items-center justify-center gap-2 shadow-lg ${
              darkMode
          ...
          >
            <Download size={24} />
            Download CSV File (Open in Excel)
          </button>
          
          {status && (
            <div className={`mt-4 p-4 rounded-lg text-center border transition-colors duration-300 ${
              darkMode
          ...
          <div className={`mt-8 rounded-lg p-6 transition-colors duration-300 ${
