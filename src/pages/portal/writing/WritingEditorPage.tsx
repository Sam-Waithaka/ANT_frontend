...
import { createEmptyLexicalContent, normalizeLexicalContent, type LexicalContentJson } from '../../../components/writing/editor/serialization';
import { extractImageBlocks, imageBlockRecordId, type ImageBlockMetadata } from '../../../components/writing/editor/imageBlocks';
  ...
  const renderDocumentSettingsPanel = (panel?: { heading?: string; sectionGroup?: 'all' | 'left' | 'right' }) => {
    ...
    return (
      <DocumentSettingsPanel
        ...
        canManageAuthors={canEditAnyWriting(auth.permissions)}
        ...
        metadata={[{ label: 'Reading time', value: String(writing.reading_time_minutes || writing.readingTimeMinutes || 0) + ' minutes' }, { label: 'Last updated', value: writing.updated_at ? new Date(writing.updated_at).toLocaleString() : 'Not available' }]}
