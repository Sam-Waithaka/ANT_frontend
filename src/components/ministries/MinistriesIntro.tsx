type MinistriesIntroProps = {
  darkMode: boolean;
};

const MinistriesIntro = ({ darkMode }: MinistriesIntroProps) => (
    ...
    <div className="mx-auto max-w-5xl">
      ...
      >
        ...
        <h1 className="mt-3 max-w-3xl text-4xl font-extrabold leading-tight tracking-normal sm:text-5xl">
          Ministries at A.I.C Njoro Town
        </h1>
        <p className={`mt-4 max-w-2xl text-base leading-7 sm:text-lg ${darkMode ? 'text-stone-300' : 'text-zinc-700'}`}>
          Page skeleton prepared for ministry categories, ministry details, resources, and eligibility information from the ministries API.
        </p>
      </div>
    </div>
  </section>
