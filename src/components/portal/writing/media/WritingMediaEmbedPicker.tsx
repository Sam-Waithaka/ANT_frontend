...
const WritingMediaEmbedPicker = ({ accessToken, canUpload, darkMode, onClose, onSelect }: WritingMediaEmbedPickerProps) => {
  ...
  return (
    <div aria-modal="true" className="fixed inset-0 z-50 grid place-items-end bg-black/25 p-0 backdrop-blur-[1px] sm:place-items-center sm:p-4" role="dialog">
      <section aria-label="Insert image" className={'max-h-[100dvh] w-full max-w-3xl overflow-y-auto rounded-t-[1.75rem] border p-4 shadow-2xl sm:max-h-[min(46rem,calc(100dvh-2rem))] sm:rounded-3xl sm:p-5 ' + surfaceClass}>
