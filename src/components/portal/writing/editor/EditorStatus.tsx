...
const EditorStatus = ({ characterCount, darkMode, saveState = 'idle', wordCount }: EditorStatusProps) => (
  <footer className={`flex flex-wrap items-center justify-between gap-3 border-t px-5 py-4 text-xs ${darkMode ? 'border-white/10 text-stone-400' : 'border-[#eaded0] text-[#786f66]'}`}>
