...
export class ApplicationBlockNode extends DecoratorNode<ReactNode> {
  ...
  getData(): PastoralBlockData { return this.__data; }
  setData(data: PastoralBlockData): void { this.getWritable().__data = data; }
  createDOM(): HTMLElement { return document.createElement('div'); }
  updateDOM(): false { return false; }
  exportJSON(): SerializedApplicationBlockNode { return { ...super.exportJSON(), data: this.__data, type: 'application-block', version: 1 }; }
  decorate(): ReactNode { return <PastoralBlockView data={this.__data} kind="application" nodeKey={this.getKey()} />; }
}
