  ...
  <div className="pt-4 sm:pt-8">
    ...
    <div className="mt-7 flex flex-col gap-3 sm:flex-row">
      ...
      <button
        ...
        className={`inline-flex min-h-12 items-center justify-center gap-2 rounded-full border px-6 py-3 font-bold transition hover:-translate-y-0.5 focus:outline-none focus:ring-2 focus:ring-red-700 focus:ring-offset-2 ${darkMode
    ...
    {status && (
      <p
        className={`mt-4 rounded-2xl border px-4 py-3 text-sm font-medium ${darkMode
