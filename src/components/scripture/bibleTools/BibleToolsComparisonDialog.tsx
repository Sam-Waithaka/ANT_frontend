...
type BibleToolsComparisonDialogProps = {
  comparison: BibleComparisonChapter;
  darkMode: boolean;
...
const BibleToolsComparisonDialog = ({
  comparison,
  darkMode,
  selectedCompareVersions,
  versionLabelFor,
  onClose,
}: BibleToolsComparisonDialogProps) => (
  <div
...
export default BibleToolsComparisonDialog;
